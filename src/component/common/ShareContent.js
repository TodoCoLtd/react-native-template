...
const ShareSource = [
    ...
    { actionTitle: 'QQ空间', actionImage: Images.icon_tabbar_home_cur, type: 4 },
    { actionTitle: '微博', actionImage: Images.icon_tabbar_home_cur, type: 5 },
]
const OtherSource = [
    { actionTitle: '复制', actionImage: Images.icon_tabbar_home_cur, type: 6 },
]
